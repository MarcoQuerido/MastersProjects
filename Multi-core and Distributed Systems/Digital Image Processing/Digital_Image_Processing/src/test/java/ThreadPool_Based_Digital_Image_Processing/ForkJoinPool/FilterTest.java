package ThreadPool_Based_Digital_Image_Processing.ForkJoinPool;

import app.Config;
import app.ThreadPool_Based_Digital_Image_Processing.FilterTypes;
import app.ThreadPool_Based_Digital_Image_Processing.ForkJoinPool.ProcessingLogic;
...
public class FilterTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fileWriter = new FileWriter(Config.OUTPUT_PATH_FORKJOINPOOL);
    ...
    private static void testFilter(FilterTypes filterType, String filePath, PrintWriter printWriter, String size) {
        ...
        for (int i = 1; i <= Config.NUM_TESTS; i++) {
            ...
            filters.applyFiltersForkJoinPool(filterType);
