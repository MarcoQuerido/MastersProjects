package ThreadPool_Based_Digital_Image_Processing.SingleThreadPool;

import app.Config;
import app.ThreadPool_Based_Digital_Image_Processing.FilterTypes;
import app.ThreadPool_Based_Digital_Image_Processing.SingleThreadPool.ProcessingLogic;
...
public class FilterTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fileWriter = new FileWriter(Config.OUTPUT_PATH_SINGLETHREADPOOL);
    ...
    private static void testFilter(FilterTypes filterType, String filePath, PrintWriter printWriter, String size) {
        ...
        for (int i = 1; i <= Config.NUM_TESTS; i++) {
            ...
            filters.applyFiltersThreadPoolSingleThread(filterType);
