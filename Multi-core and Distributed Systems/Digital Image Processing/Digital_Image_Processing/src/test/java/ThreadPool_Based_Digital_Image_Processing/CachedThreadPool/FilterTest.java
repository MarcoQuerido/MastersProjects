package ThreadPool_Based_Digital_Image_Processing.CachedThreadPool;

import app.Config;
import app.ThreadPool_Based_Digital_Image_Processing.FilterTypes;
import app.ThreadPool_Based_Digital_Image_Processing.CachedThreadPool.ProcessingLogic;
...
public class FilterTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fileWriter = new FileWriter(Config.OUTPUT_PATH_CACHEDTHREADPOOL);
    ...
    private static void testFilter(FilterTypes filterType, String filePath, PrintWriter printWriter, String size) {
        ...
        for (int i = 1; i <= Config.NUM_TESTS; i++) {
            ...
            // Apply the filter using CachedThreadPool
            ExecutorService executor = Executors.newCachedThreadPool();
            ProcessingLogic filters = new ProcessingLogic(filePath);
            filters.applyFiltersCachedThreadPool(filterType);
            executor.shutdown();
