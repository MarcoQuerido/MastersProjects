 ...
 * </p>
 * <ul>
 *   <li>{@link cr2.impl.ModerationProcessImpl#getName <em>Name</em>}</li>
 *   <li>{@link cr2.impl.ModerationProcessImpl#isCanDelete <em>Can Delete</em>}</li>
 *   <li>{@link cr2.impl.ModerationProcessImpl#getStep <em>Step</em>}</li>
 *   <li>{@link cr2.impl.ModerationProcessImpl#getStartStop <em>Start Stop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModerationProcessImpl extends EObjectImpl implements ModerationProcess {
	/**
	...
	public void setCanDelete(boolean newCanDelete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.MODERATION_PROCESS__CAN_DELETE, oldCanDelete, canDelete));
	}
	...
	public ValidationStep getStartStop() {
		if (startStop != null && startStop.eIsProxy()) {
			...
			if (startStop != oldStartStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cr2Package.MODERATION_PROCESS__START_STOP, oldStartStop, startStop));
			}
		}
		return startStop;
	}
	...
	public void setStartStop(ValidationStep newStartStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.MODERATION_PROCESS__START_STOP, oldStartStop, startStop));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Cr2Package.MODERATION_PROCESS__START_STOP:
				if (resolve) return getStartStop();
