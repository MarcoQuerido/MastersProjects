...
/**
 * This is the item provider adapter for a {@link cr2.Review} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Review_gradeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Review_gradeType_feature", "_UI_Review_type"),
				 Cr2Package.Literals.REVIEW__GRADE_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addReviewTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Review_reviewType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Review_reviewType_feature", "_UI_Review_type"),
				 Cr2Package.Literals.REVIEW__REVIEW_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
