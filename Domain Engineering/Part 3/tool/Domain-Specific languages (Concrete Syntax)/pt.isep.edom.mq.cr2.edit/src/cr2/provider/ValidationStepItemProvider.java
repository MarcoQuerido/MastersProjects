...
/**
 * This is the item provider adapter for a {@link cr2.ValidationStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValidationStepItemProvider extends StepItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValidationStep_nextApprove_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValidationStep_nextApprove_feature", "_UI_ValidationStep_type"),
				 Cr2Package.Literals.VALIDATION_STEP__NEXT_APPROVE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNextRejectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValidationStep_nextReject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValidationStep_nextReject_feature", "_UI_ValidationStep_type"),
				 Cr2Package.Literals.VALIDATION_STEP__NEXT_REJECT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ValidationStep_type") :
