 ...
 * @generated
 */
public class ModerationProcessItemSemanticEditPolicy extends Cr2BaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ModerationProcessItemSemanticEditPolicy() {
		super(Cr2ElementTypes.ModerationProcess_2002);
	}
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case AutomaticEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (Cr2VisualIDRegistry
									.getVisualID(incomingLink) == ValidationStepNextApproveEditPart.VISUAL_ID) {
							...
							if (Cr2VisualIDRegistry
									.getVisualID(incomingLink) == ValidationStepNextRejectEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (Cr2VisualIDRegistry
									.getVisualID(outgoingLink) == ValidationStepNextApproveEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
							...
							if (Cr2VisualIDRegistry
									.getVisualID(outgoingLink) == ValidationStepNextRejectEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
