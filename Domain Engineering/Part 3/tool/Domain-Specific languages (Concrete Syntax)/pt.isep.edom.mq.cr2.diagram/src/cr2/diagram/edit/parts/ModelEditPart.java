...
import cr2.diagram.edit.commands.Cr2CreateShortcutDecorationsCommand;
import cr2.diagram.edit.policies.ModelCanonicalEditPolicy;
import cr2.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Cr2"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new Cr2CreateShortcutDecorationsCommand(getEditingDomain(),
