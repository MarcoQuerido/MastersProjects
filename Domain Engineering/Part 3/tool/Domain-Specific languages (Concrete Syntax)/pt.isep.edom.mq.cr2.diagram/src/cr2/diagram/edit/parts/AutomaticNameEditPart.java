...
public class AutomaticNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.Automatic_3002, getParserElement(),
					Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.AutomaticNameEditPart.VISUAL_ID));
		}
		return parser;
	}
