...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.ValidationStepNextApprove_4002, getParserElement(),
