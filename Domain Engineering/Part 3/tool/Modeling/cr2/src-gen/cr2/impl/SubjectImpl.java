...
public class SubjectImpl extends MinimalEObjectImpl.Container implements Subject {
	...
	public NotificationChain basicSetFeature(Feature newFeature, NotificationChain msgs) {
		...
		feature = newFeature;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Cr2Package.SUBJECT__FEATURE,
		...
		if (newFeature != feature) {
			...
			if (feature != null)
				msgs = ((InternalEObject) feature).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Cr2Package.SUBJECT__FEATURE, null, msgs);
			if (newFeature != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.SUBJECT__FEATURE, newFeature, newFeature));
	}
