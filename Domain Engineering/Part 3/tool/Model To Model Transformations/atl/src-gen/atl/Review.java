 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.atb.cr2.Review#getGradeType <em>Grade Type</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.Review#getReviewType <em>Review Type</em>}</li>
 * </ul>
 *
 * @see pt.isep.edom.atb.cr2.Cr2Package#getReview()
 * @model
 * @generated
 */
public interface Review extends UserFeedback {
	 ...
	 * The literals are from the enumeration {@link pt.isep.edom.atb.cr2.GradeType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Grade Type</em>' attribute.
	 * @see pt.isep.edom.atb.cr2.GradeType
	 * @see #setGradeType(GradeType)
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getReview_GradeType()
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Review#getGradeType <em>Grade Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link pt.isep.edom.atb.cr2.ReviewType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Review Type</em>' attribute.
	 * @see pt.isep.edom.atb.cr2.ReviewType
	 * @see #setReviewType(ReviewType)
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getReview_ReviewType()
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Review#getReviewType <em>Review Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
