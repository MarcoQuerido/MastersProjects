 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.atb.cr2.Comment#isReply <em>Reply</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.Comment#isModeration <em>Moderation</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.Comment#getCommentType <em>Comment Type</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.Comment#getModerationProcess <em>Moderation Process</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.Comment#isHasModerationProcess <em>Has Moderation Process</em>}</li>
 * </ul>
 *
 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment()
 * @model
 * @generated
 */
public interface Comment extends UserFeedback {
	 ...
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment_Reply()
	 * @model required="true"
	 * @generated
	 */
	boolean isReply();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Comment#isReply <em>Reply</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment_Moderation()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Comment#isModeration <em>Moderation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link pt.isep.edom.atb.cr2.CommentType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Comment Type</em>' attribute.
	 * @see pt.isep.edom.atb.cr2.CommentType
	 * @see #setCommentType(CommentType)
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment_CommentType()
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Comment#getCommentType <em>Comment Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment_ModerationProcess()
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.atb.cr2.Comment#getModerationProcess <em>Moderation Process</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pt.isep.edom.atb.cr2.Cr2Package#getComment_HasModerationProcess()
