 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.SubjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.SubjectImpl#getUserFeedback <em>User Feedback</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.SubjectImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.SubjectImpl#getFeatureCount <em>Feature Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectImpl extends MinimalEObjectImpl.Container implements Subject {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate FEATURE_COUNT__ESETTING_DELEGATE = ((EStructuralFeature.Internal) Cr2Package.Literals.SUBJECT__FEATURE_COUNT)
			.getSettingDelegate();
