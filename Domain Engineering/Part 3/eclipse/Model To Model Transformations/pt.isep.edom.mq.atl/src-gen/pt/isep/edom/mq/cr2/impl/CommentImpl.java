 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.CommentImpl#isReply <em>Reply</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.CommentImpl#isModeration <em>Moderation</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.CommentImpl#getCommentType <em>Comment Type</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.CommentImpl#getModerationProcess <em>Moderation Process</em>}</li>
 *   <li>{@link pt.isep.edom.atb.cr2.impl.CommentImpl#isHasModerationProcess <em>Has Moderation Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentImpl extends UserFeedbackImpl implements Comment {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate HAS_MODERATION_PROCESS__ESETTING_DELEGATE = ((EStructuralFeature.Internal) Cr2Package.Literals.COMMENT__HAS_MODERATION_PROCESS)
			.getSettingDelegate();
