...
public class Refactor {
	...
	public static void main(String[] args) {
		...
		//refactoringTransformation("featurename2uppercase", "http://www.example.org/cr2", "instances/example1.xmi", "instances/example1-output1.xmi");

		refactoringTransformation("addendstep", "http://www.example.org/cr2", "instances/example2.xmi", "instances/example2-output2.xmi");
