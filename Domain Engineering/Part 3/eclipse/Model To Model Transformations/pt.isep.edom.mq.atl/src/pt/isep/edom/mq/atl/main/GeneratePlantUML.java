package pt.isep.edom.mq.atl.main;
...
import pt.isep.edom.mq.atl.Cr2Factory;
import pt.isep.edom.mq.atl.Cr2Package;
import pt.isep.edom.mq.atl.Model;
import pt.isep.edom.mq.atl.Subject;
import pt.isep.edom.mq.atl.UserFeedback;
...
public class GeneratePlantUML {
	...
	public static void main(String[] args) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("cr2", new XMIResourceFactoryImpl());
		...
		Resource resource = resSet.getResource(URI.createURI("instances/amazon.cr2"), true);
