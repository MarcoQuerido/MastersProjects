 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.mq.cr2.ValidationStep#getNextApprove <em>Next Approve</em>}</li>
 *   <li>{@link pt.isep.edom.mq.cr2.ValidationStep#getNextReject <em>Next Reject</em>}</li>
 * </ul>
 *
 * @see pt.isep.edom.mq.cr2.Cr2Package#getValidationStep()
 * @model abstract="true"
 * @generated
 */
public interface ValidationStep extends Step {
	 ...
	 * @see pt.isep.edom.mq.cr2.Cr2Package#getValidationStep_NextApprove()
	 * @model required="true"
	 * @generated
	 */
	Step getNextApprove();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.mq.cr2.ValidationStep#getNextApprove <em>Next Approve</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pt.isep.edom.mq.cr2.Cr2Package#getValidationStep_NextReject()
	 * @model required="true"
	 * @generated
	 */
	Step getNextReject();
	...
	/**
	 * Sets the value of the '{@link pt.isep.edom.mq.cr2.ValidationStep#getNextReject <em>Next Reject</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
