...
import pt.isep.edom.mq.cr2.Automatic;
import pt.isep.edom.mq.cr2.Comment;
import pt.isep.edom.mq.cr2.CommentType;
import pt.isep.edom.mq.cr2.Cr2Factory;
import pt.isep.edom.mq.cr2.Cr2Package;
import pt.isep.edom.mq.cr2.End;
import pt.isep.edom.mq.cr2.Feature;
import pt.isep.edom.mq.cr2.GradeType;
import pt.isep.edom.mq.cr2.Manual;
import pt.isep.edom.mq.cr2.Model;
import pt.isep.edom.mq.cr2.ModerationProcess;
import pt.isep.edom.mq.cr2.Review;
import pt.isep.edom.mq.cr2.ReviewType;
...
public class Cr2PackageImpl extends EPackageImpl implements Cr2Package {
	 ...
	 * @see pt.isep.edom.mq.cr2.Cr2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSubject_Name(), ecorePackage.getEString(), "name", null, 0, 1, Subject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSubject_FeatureCount(), ecorePackage.getEBigInteger(), "featureCount", null, 0, 1,
		...
		initEAttribute(getReview_GradeType(), this.getGradeType(), "gradeType", null, 0, 1, Review.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReview_ReviewType(), this.getReviewType(), "reviewType", null, 0, 1, Review.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(commentEClass, Comment.class, "Comment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getComment_Reply(), ecorePackage.getEBoolean(), "reply", null, 0, 1, Comment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComment_Moderation(), ecorePackage.getEBoolean(), "moderation", null, 0, 1, Comment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComment_CommentType(), this.getCommentType(), "commentType", null, 0, 1, Comment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComment_HasModerationProcess(), ecorePackage.getEBoolean(), "hasModerationProcess", null, 0,
		...
		initEAttribute(getModerationProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				...
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getModerationProcess_CanDelete(), ecorePackage.getEBoolean(), "canDelete", null, 0, 1,
				ModerationProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getModerationProcess_Step(), this.getStep(), null, "step", null, 0, -1, ModerationProcess.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModerationProcess_StartStop(), this.getValidationStep(), null, "startStop", null, 1, 1,
