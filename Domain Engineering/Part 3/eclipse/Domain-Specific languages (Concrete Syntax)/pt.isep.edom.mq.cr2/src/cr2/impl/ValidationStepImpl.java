 ...
 * </p>
 * <ul>
 *   <li>{@link cr2.impl.ValidationStepImpl#getNextApprove <em>Next Approve</em>}</li>
 *   <li>{@link cr2.impl.ValidationStepImpl#getNextReject <em>Next Reject</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ValidationStepImpl extends StepImpl implements ValidationStep {
		...
		if (nextApprove != null && nextApprove.eIsProxy()) {
			...
			if (nextApprove != oldNextApprove) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cr2Package.VALIDATION_STEP__NEXT_APPROVE, oldNextApprove, nextApprove));
			}
		}
		return nextApprove;
	}
	...
	public void setNextApprove(Step newNextApprove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.VALIDATION_STEP__NEXT_APPROVE, oldNextApprove, nextApprove));
	}
	...
	public Step getNextReject() {
		if (nextReject != null && nextReject.eIsProxy()) {
			...
			if (nextReject != oldNextReject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Cr2Package.VALIDATION_STEP__NEXT_REJECT, oldNextReject, nextReject));
			}
		}
		return nextReject;
	}
	...
	public void setNextReject(Step newNextReject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.VALIDATION_STEP__NEXT_REJECT, oldNextReject, nextReject));
	}
