 ...
 * </p>
 * <ul>
 *   <li>{@link cr2.impl.SubjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link cr2.impl.SubjectImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link cr2.impl.SubjectImpl#getUserfeedback <em>Userfeedback</em>}</li>
 *   <li>{@link cr2.impl.SubjectImpl#getFeatureCount <em>Feature Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectImpl extends EObjectImpl implements Subject {
	...
	/**
	 * The cached setting delegate for the '{@link #getFeatureCount() <em>Feature Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFeatureCount()
	 * @generated
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate FEATURE_COUNT__ESETTING_DELEGATE = ((EStructuralFeature.Internal)Cr2Package.Literals.SUBJECT__FEATURE_COUNT).getSettingDelegate();
	...
	public EList<UserFeedback> getUserfeedback() {
		if (userfeedback == null) {
			userfeedback = new EObjectContainmentWithInverseEList<UserFeedback>(UserFeedback.class, this, Cr2Package.SUBJECT__USERFEEDBACK, Cr2Package.USER_FEEDBACK__SUBJECT);
		}
		return userfeedback;
	}
	...
	public BigInteger getFeatureCount() {
		return (BigInteger)FEATURE_COUNT__ESETTING_DELEGATE.dynamicGet(this, null, 0, true, false);
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Cr2Package.SUBJECT__FEATURE_COUNT:
				return FEATURE_COUNT__ESETTING_DELEGATE.dynamicIsSet(this, null, 0);
		}
