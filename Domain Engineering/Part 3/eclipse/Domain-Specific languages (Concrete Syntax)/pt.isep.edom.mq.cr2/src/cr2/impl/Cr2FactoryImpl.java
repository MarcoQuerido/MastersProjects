...
public class Cr2FactoryImpl extends EFactoryImpl implements Cr2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Cr2Package.MODEL: return createModel();
			case Cr2Package.SUBJECT: return createSubject();
			case Cr2Package.FEATURE: return createFeature();
			case Cr2Package.REVIEW: return createReview();
			case Cr2Package.COMMENT: return createComment();
			case Cr2Package.MODERATION_PROCESS: return createModerationProcess();
			case Cr2Package.END: return createEnd();
			case Cr2Package.AUTOMATIC: return createAutomatic();
			case Cr2Package.MANUAL: return createManual();
			default:
