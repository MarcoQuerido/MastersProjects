 ...
 * </p>
 * <ul>
 *   <li>{@link cr2.impl.UserFeedbackImpl#getName <em>Name</em>}</li>
 *   <li>{@link cr2.impl.UserFeedbackImpl#getSubject <em>Subject</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserFeedbackImpl extends EObjectImpl implements UserFeedback {
	/**
	...
	public Subject getSubject() {
		if (eContainerFeatureID() != Cr2Package.USER_FEEDBACK__SUBJECT) return null;
	...
	public void setSubject(Subject newSubject) {
		if (newSubject != eInternalContainer() || (eContainerFeatureID() != Cr2Package.USER_FEEDBACK__SUBJECT && newSubject != null)) {
			...
			if (newSubject != null)
				msgs = ((InternalEObject)newSubject).eInverseAdd(this, Cr2Package.SUBJECT__USERFEEDBACK, Subject.class, msgs);
			msgs = basicSetSubject(newSubject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr2Package.USER_FEEDBACK__SUBJECT, newSubject, newSubject));
	}
