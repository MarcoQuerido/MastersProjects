...
public class FeatureNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.Feature_3001, getParserElement(),
					Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.FeatureNameEditPart.VISUAL_ID));
		}
		return parser;
	}
