...
public class ManualNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.Manual_3003, getParserElement(),
					Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.ManualNameEditPart.VISUAL_ID));
		}
		return parser;
	}
