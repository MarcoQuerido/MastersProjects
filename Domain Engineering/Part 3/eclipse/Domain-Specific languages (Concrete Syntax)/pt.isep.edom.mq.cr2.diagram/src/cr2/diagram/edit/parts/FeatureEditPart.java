...
import cr2.diagram.edit.policies.FeatureCanonicalEditPolicy;
import cr2.diagram.edit.policies.FeatureItemSemanticEditPolicy;
...
public class FeatureEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FeatureNameEditPart) {
			((FeatureNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureFeatureLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Cr2VisualIDRegistry.getType(FeatureNameEditPart.VISUAL_ID));
	}
