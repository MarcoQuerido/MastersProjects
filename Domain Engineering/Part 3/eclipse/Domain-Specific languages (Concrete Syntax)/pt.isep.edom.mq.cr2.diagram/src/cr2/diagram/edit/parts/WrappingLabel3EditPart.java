...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.ValidationStepNextReject_4003, getParserElement(),
