...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.SubjectUserfeedback_4001, getParserElement(),
