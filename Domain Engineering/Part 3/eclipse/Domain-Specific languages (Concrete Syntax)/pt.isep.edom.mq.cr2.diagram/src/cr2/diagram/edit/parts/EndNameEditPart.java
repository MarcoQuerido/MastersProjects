...
public class EndNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.End_3004, getParserElement(),
					Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.EndNameEditPart.VISUAL_ID));
		}
		return parser;
	}
