...
import cr2.diagram.edit.policies.Cr2TextSelectionEditPolicy;
 ...
 * @generated
 */
public class ModerationProcessNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModerationProcessNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new Cr2TextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return Cr2ElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Cr2ParserProvider.getParser(Cr2ElementTypes.ModerationProcess_2002, getParserElement(),
					Cr2VisualIDRegistry.getType(cr2.diagram.edit.parts.ModerationProcessNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, Cr2EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
