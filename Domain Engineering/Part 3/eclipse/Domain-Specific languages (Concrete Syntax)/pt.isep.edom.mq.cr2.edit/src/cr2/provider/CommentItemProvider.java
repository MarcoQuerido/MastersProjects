...
/**
 * This is the item provider adapter for a {@link cr2.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Cr2Package.Literals.COMMENT__REPLY,
				 true,
				 false,
				 false,
	...
	protected void addModerationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_moderation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_moderation_feature", "_UI_Comment_type"),
				 Cr2Package.Literals.COMMENT__MODERATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addCommentTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_commentType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_commentType_feature", "_UI_Comment_type"),
				 Cr2Package.Literals.COMMENT__COMMENT_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addHasModerationProcessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_hasModerationProcess_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_hasModerationProcess_feature", "_UI_Comment_type"),
				 Cr2Package.Literals.COMMENT__HAS_MODERATION_PROCESS,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Cr2Package.Literals.COMMENT__MODERATIONPROCESS,
