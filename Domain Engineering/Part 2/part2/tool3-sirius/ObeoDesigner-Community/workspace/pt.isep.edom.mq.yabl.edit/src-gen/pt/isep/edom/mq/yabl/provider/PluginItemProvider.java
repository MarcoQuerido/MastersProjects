...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.mq.yabl.Plugin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PluginItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Plugin_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Plugin_id_feature", "_UI_Plugin_type"),
						YablPackage.Literals.PLUGIN__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Plugin_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Plugin_name_feature", "_UI_Plugin_type"),
						YablPackage.Literals.PLUGIN__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Plugin_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Plugin_type_feature", "_UI_Plugin_type"),
						YablPackage.Literals.PLUGIN__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case YablPackage.PLUGIN__ID:
		case YablPackage.PLUGIN__NAME:
		case YablPackage.PLUGIN__TYPE:
