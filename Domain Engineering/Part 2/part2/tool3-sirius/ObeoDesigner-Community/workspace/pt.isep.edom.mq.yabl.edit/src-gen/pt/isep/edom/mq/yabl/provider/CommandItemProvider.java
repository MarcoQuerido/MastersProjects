...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.mq.yabl.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						YablPackage.Literals.COMMAND__NAME, true, false, false,
	...
	protected void addCommandlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Command_commandline_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Command_commandline_feature",
								"_UI_Command_type"),
						YablPackage.Literals.COMMAND__COMMANDLINE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(YablPackage.Literals.COMMAND__MODIFIED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(YablPackage.Literals.COMMAND__MODIFIED, YablFactory.eINSTANCE.createPrefix()));
	}
