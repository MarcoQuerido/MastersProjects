...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.mq.yabl.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Function_name_feature",
								"_UI_Function_type"),
						YablPackage.Literals.FUNCTION__NAME, true, false, false,
	...
	protected void addVariablesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_variables_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_variables_feature",
								"_UI_Function_type"),
						YablPackage.Literals.FUNCTION__VARIABLES, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case YablPackage.FUNCTION__NAME:
		case YablPackage.FUNCTION__VARIABLES:
