...
/**
 * This is the item provider adapter for a {@link test_project.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.FILE__FILENAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Test_projectPackage.Literals.FILE__FUNTIONS);
			childrenFeatures.add(Test_projectPackage.Literals.FILE__TARGET);
			childrenFeatures.add(Test_projectPackage.Literals.FILE__PREREQUISITE);
			childrenFeatures.add(Test_projectPackage.Literals.FILE__TASKS);
			childrenFeatures.add(Test_projectPackage.Literals.FILE__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.FILE__FUNTIONS,
				 Test_projectFactory.eINSTANCE.createFunction()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.FILE__TARGET,
				 Test_projectFactory.eINSTANCE.createFile()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.FILE__PREREQUISITE,
				 Test_projectFactory.eINSTANCE.createFile()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.FILE__TASKS,
				 Test_projectFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.FILE__ATTRIBUTES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Test_projectPackage.Literals.FILE__TARGET ||
			childFeature == Test_projectPackage.Literals.FILE__PREREQUISITE;
