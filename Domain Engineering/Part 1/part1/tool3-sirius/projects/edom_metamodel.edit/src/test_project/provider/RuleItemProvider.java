...
/**
 * This is the item provider adapter for a {@link test_project.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.RULE__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Test_projectPackage.Literals.RULE__ATTRIBUTES);
			childrenFeatures.add(Test_projectPackage.Literals.RULE__DEPENDENCIES);
			childrenFeatures.add(Test_projectPackage.Literals.RULE__TARGET);
			childrenFeatures.add(Test_projectPackage.Literals.RULE__COMMANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.RULE__ATTRIBUTES,
				 Test_projectFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.RULE__DEPENDENCIES,
				 Test_projectFactory.eINSTANCE.createFile()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.RULE__TARGET,
				 Test_projectFactory.eINSTANCE.createFile()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.RULE__COMMANDS,
				 Test_projectFactory.eINSTANCE.createCommand()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Test_projectPackage.Literals.RULE__DEPENDENCIES ||
			childFeature == Test_projectPackage.Literals.RULE__TARGET;
