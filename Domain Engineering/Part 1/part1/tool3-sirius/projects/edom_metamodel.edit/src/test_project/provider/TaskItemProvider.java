...
/**
 * This is the item provider adapter for a {@link test_project.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.TASK__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.TASK__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_script_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_script_feature", "_UI_Task_type"),
				 Test_projectPackage.Literals.TASK__SCRIPT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Test_projectPackage.Literals.TASK__ACTION);
			childrenFeatures.add(Test_projectPackage.Literals.TASK__ATTRIBUTES);
			childrenFeatures.add(Test_projectPackage.Literals.TASK__TASK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.TASK__ACTION,
				 Test_projectFactory.eINSTANCE.createAction()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.TASK__ATTRIBUTES,
				 Test_projectFactory.eINSTANCE.createParameters()));

		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.TASK__TASK,
