...
/**
 * This is the item provider adapter for a {@link test_project.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_commandline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_commandline_feature", "_UI_Command_type"),
				 Test_projectPackage.Literals.COMMAND__COMMANDLINE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Test_projectPackage.Literals.COMMAND__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Test_projectPackage.Literals.COMMAND__MODIFIED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Test_projectPackage.Literals.COMMAND__MODIFIED,
				 Test_projectFactory.eINSTANCE.createPrefix()));
	}
