...
public class MongoCrudTestsReview {
    ...
    void testFindByProduct() {
        ...
        Optional<List<ReviewMongo>> reviewsByProduct = reviewRepository.findByProduct(product.getProductID());
    ...
    void testFindByProductAndApprovalStatus() {
        reviewRepository.save(review);
        Optional<List<ReviewMongo>> reviewsByProductAndStatus = reviewRepository.findByProductIdAndApprovalStatus(product.getProductID(), "pending");
    ...
    void testFindByUser() {
        reviewRepository.save(review);
        Optional<List<ReviewMongo>> reviewsByUser = reviewRepository.findByUserID(user.getId());
