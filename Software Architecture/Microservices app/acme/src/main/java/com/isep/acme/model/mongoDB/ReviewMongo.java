...
public class ReviewMongo {
    ...
    public ReviewMongo(String idReview, long version, String approvalStatus, String reviewText,
                       List<Vote> upVote, List<Vote> downVote, String report, LocalDate publishingDate,
                       String funFact, ProductMongo productMongo, RatingMongo ratingMongo, UserMongo userMongo) {
        this.id = idReview;
        ...
        setPublishingDate(publishingDate);
        setFunFact(funFact);
        this.product = productMongo;
        this.rating = ratingMongo;
        this.user = userMongo;
    }
