...
import org.trebol.repository.ProductCategoryRepository;
import org.trebol.service.dto.ProductCategoryDTO;
import org.trebol.service.mapper.ProductCategoryMapper;
...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().code(DEFAULT_CODE).name(DEFAULT_NAME);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().code(UPDATED_CODE).name(UPDATED_NAME);
        return productCategory;
    }
    ...
    void partialUpdateProductCategoryWithPatch() throws Exception {
        ...
        partialUpdatedProductCategory.code(UPDATED_CODE);
