...
import org.trebol.repository.PersonRepository;
import org.trebol.service.dto.PersonDTO;
import org.trebol.service.mapper.PersonMapper;
...
class PersonResourceIT {
    ...
    @Test
    @Transactional
    void checkPhone2IsRequired() throws Exception {
        int databaseSizeBeforeTest = personRepository.findAll().size();
        // set the field null
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.idNumber(UPDATED_ID_NUMBER);
