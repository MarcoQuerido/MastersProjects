...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shipper.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPPER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIPPER actions', async () => {
      const expectedActions = [
        {
