...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './costumer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COSTUMER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COSTUMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COSTUMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COSTUMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COSTUMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COSTUMER actions', async () => {
      const expectedActions = [
        {
