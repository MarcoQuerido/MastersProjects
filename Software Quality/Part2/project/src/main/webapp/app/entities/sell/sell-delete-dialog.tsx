...
export const SellDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trebolApp.sell.delete.question">
        <Translate contentKey="trebolApp.sell.delete.question" interpolate={{ id: sellEntity.id }}>
