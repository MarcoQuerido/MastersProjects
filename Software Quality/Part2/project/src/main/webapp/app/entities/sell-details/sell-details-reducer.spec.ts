...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELLDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELLDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELLDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELLDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELLDETAILS actions', async () => {
      const expectedActions = [
        {
