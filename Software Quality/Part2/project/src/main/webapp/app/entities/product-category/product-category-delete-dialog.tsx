...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trebolApp.productCategory.delete.question">
        <Translate contentKey="trebolApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
