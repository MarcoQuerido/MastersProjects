...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTTYPE actions', async () => {
      const expectedActions = [
        {
