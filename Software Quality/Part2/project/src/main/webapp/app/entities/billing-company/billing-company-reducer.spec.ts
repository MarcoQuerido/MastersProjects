...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLINGCOMPANY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLINGCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLINGCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLINGCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLINGCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLINGCOMPANY actions', async () => {
      const expectedActions = [
        {
