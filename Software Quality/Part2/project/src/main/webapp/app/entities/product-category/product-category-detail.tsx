    ...
    <Row>
      <Col md="8">
        <h2 data-cy="productCategoryDetailsHeading">
          <Translate contentKey="trebolApp.productCategory.detail.title">ProductCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{productCategoryEntity.parent ? productCategoryEntity.parent.id : ''}</dd>
        </dl>
