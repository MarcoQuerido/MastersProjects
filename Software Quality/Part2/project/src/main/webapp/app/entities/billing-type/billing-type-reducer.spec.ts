...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLINGTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLINGTYPE actions', async () => {
      const expectedActions = [
        {
