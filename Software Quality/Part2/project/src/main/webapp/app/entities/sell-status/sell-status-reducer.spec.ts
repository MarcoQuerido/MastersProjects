...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELLSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELLSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELLSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELLSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELLSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELLSTATUS actions', async () => {
      const expectedActions = [
        {
